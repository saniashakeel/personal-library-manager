...
# Attempt to import streamlit_lottie
try:
    from streamlit_lottie import st_lottie
except ImportError:
    st.warning("⚠️ streamlit_lottie is not installed. Install it using: `pip install streamlit-lottie`")
...
if st.session_state.current_view == "library":
    ...
    if not st.session_state.library:
        st.warning("⚠️ Your library is empty. Add some books to get started!")
    else:
...
st.markdown("---")
st.markdown("© 2025 Sania Shakeel | 📚 Personal Library Manager", unsafe_allow_html=True)
